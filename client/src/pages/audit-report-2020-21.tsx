...
import auditReportPdf from "@assets/Management-Ac-20-21_compressed.pdf";

export default function AuditReport2020_21() {
  const keyHighlights = [
    {
  ...
  const financialMetrics = [
    { metric: "Total Income", status: "Stable", color: "bg-blue-100 text-blue-800" },
    { metric: "Expenditure Management", status: "Good", color: "bg-green-100 text-green-800" },
    { metric: "Asset Utilization", status: "Satisfactory", color: "bg-blue-100 text-blue-800" },
    { metric: "Liquidity Position", status: "Adequate", color: "bg-green-100 text-green-800" }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold mb-2">Management Audit Report 2020-21</h1>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    The Management Audit Report for the financial year 2020-21 provides a comprehensive 
                    ...
                    transparency and good governance practices during challenging times.
                  </p>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">April 2020 - March 2021</span>
                    </div>
                    <div className="flex justify-between">
