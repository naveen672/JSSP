...
import auditReportPdf from "@assets/Management-Ac-21-22.pdf";

export default function AuditReport2021_22() {
  const keyHighlights = [
    {
  ...
  const financialMetrics = [
    { metric: "Total Income", status: "Good", color: "bg-blue-100 text-blue-800" },
    { metric: "Expenditure Management", status: "Satisfactory", color: "bg-green-100 text-green-800" },
    { metric: "Asset Utilization", status: "Good", color: "bg-blue-100 text-blue-800" },
    { metric: "Liquidity Position", status: "Stable", color: "bg-green-100 text-green-800" }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold mb-2">Management Audit Report 2021-22</h1>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    The Management Audit Report for the financial year 2021-22 provides a comprehensive 
